...
//to edit here to make the line invesible change the stroke color and make it un visible
    ...
    force.nodes(json.nodes).links(json.links).gravity(document.getElementById('gravitySlider').value).linkDistance(document.getElementById('attractionSlider').value)
        .charge(document.getElementById('repulsionSlider').value).start();
